...
class DialView @JvmOverloads constructor(
    ...
    //Calculate the size for the custom view's dial. Import kotlin.math.min
    override fun onSizeChanged(width: Int, height: Int, oldWidth: Int, oldHeight: Int) {
        radius = (min(width, height) / 2.0 * 0.8).toFloat()
    }

    //extension function on the PointF class calculates the X, Y coordinates on the screen for the text
    // label and current indicator (0, 1, 2, or 3), given the current FanSpeed position and radius of the
    // dial
